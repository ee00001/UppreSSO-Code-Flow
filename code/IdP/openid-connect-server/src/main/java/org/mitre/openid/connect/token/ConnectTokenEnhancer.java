	...
	public OAuth2AccessToken enhance(OAuth2AccessToken accessToken,	OAuth2Authentication authentication) {
		...
		if (originalAuthRequest.getScope().contains(SystemScopeService.OPENID_SCOPE)
			...
			if (userInfo != null) {
				...
				byte[] encodedPoint = Hex.decode(clientId);
				ECPoint point = ecSpec.getCurve().decodePoint(encodedPoint);
				String uid = "303e020100301006072a8648ce3d020106052b8104000a0427302502010104208c59df7d7a252f1f670bb8f4bb0c57e26f1f60e87bc54803bcc441375079317e";

				String sub = bytesToHexString(point.multiply(new BigInteger(uid, 16)).getEncoded(false));
