...
declare abstract class PubliclyVerifiableIssuer {
    ...
    readonly params?: BlindRSAPlatformParams | undefined;
    private suite;
    constructor(mode: BlindRSAMode, name: string, privateKey: CryptoKey, publicKey: CryptoKey, params?: BlindRSAPlatformParams | undefined);
