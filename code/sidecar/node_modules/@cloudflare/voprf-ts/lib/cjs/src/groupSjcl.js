...
var _a, _GroupSj_cache;
Object.defineProperty(exports, "__esModule", { value: true });
exports.GroupConsSjcl = void 0;
const util_js_1 = require("./util.js");
const index_js_1 = __importDefault(require("./sjcl/index.js"));
...
class ScalarSj {
    ...
    static create(g) {
        return new ScalarSj(g, new index_js_1.default.bn(0));
    }
    isEqual(s) {
    ...
    static deserialize(g, bytes) {
        (0, util_js_1.checkSize)(bytes, ScalarSj, g);
        ...
        if (k.greaterEquals(getCurve(g.id).r)) {
            throw (0, util_js_1.errDeserialization)(ScalarSj);
        }
...
class EltSj {
    ...
    static create(g) {
        return new EltSj(g, new index_js_1.default.ecc.point(getCurve(g.id)));
    }
    static gen(g) {
    ...
    mul(s) {
        (0, util_js_1.compat)(this, s);
        return new EltSj(this.g, this.p.mult(s.k));
    }
    mul2(k1, a, k2) {
        (0, util_js_1.compat)(this, k1);
        (0, util_js_1.compat)(this, k2);
        (0, util_js_1.compat)(this, a);
        return new EltSj(this.g, this.p.mult2(k1.k, k2.k, a.p));
    }
    ...
    static deserComp(g, bytes) {
        ...
        if (!point.isValid()) {
            throw (0, util_js_1.errDeserialization)(EltSj);
        }
...
//# sourceMappingURL=groupSjcl.js.map