...
public class TestOHttpLocal {
    public static void main(String[] args) throws Exception {
        ...
        // 4️ 服务器收到 OHTTP 请求并解密
        OHttpRequest parsedReq = OHttpRequest.parseWire(wireRequest);
        OHttpRequest.Context serverCtx = parsedReq.buildServerContext(serverKp);
        ...
        OHttpResponse serverResp = OHttpResponse.createServerOHttpResponse(plainResponse, serverCtx, keyConfig, rnd);
